...
Aggregate statistical results, metadata, and documentation supporting this study will be deposited in Borealis, the Canadian Dataverse Repository, under the reserved DOI \url{https://doi.org/10.5683/SP4/7YSHYF}. Participant-level sensor recordings, GaitRite files, synchronization records, and derived records are not publicly available because the approved ethics protocol restricts de-identified data access to approved research personnel and does not permit web storage. Analysis code will be released through the \href{https://github.com/pkudzia/manuscript-heel-imu-stride-length-validation}{project GitHub repository}.
