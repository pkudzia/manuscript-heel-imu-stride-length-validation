...
This work was supported by the Alzheimer Society of BC and Yukon (formerly the Alzheimer Society of B.C.).
...
The Human Research Ethics Board of the University of Victoria gave ethical approval for this work (protocol H22-00451). All participants provided written informed consent.

\clearpage
\section*{Data Availability}

De-identified participant-level bilateral heel IMU recordings, GaitRite files, synchronization records, metadata, and documentation supporting this study will be made available through Borealis, the Canadian Dataverse Repository, under the reserved DOI \url{https://doi.org/10.5683/SP4/7YSHYF}. Analysis code and reproducible manuscript materials will be made available through the \href{https://github.com/pkudzia/manuscript-heel-imu-stride-length-validation}{project GitHub repository}. Both repositories will be released publicly upon publication.
