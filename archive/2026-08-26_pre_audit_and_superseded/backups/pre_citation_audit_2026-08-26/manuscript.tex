...
A multi-position study in 14 healthy young adults found higher single-stride error at the heel than at five other foot-mounted locations, particularly during fast walking \citep{Kuderle2022}. Arens et al. used bilateral foot-mounted sensors and contralateral toe-off information in eight people post-stroke, with optical motion capture as the reference \citep{Arens2021}. A heel-mounted bilateral ZUPT stance-detection and stride-length pipeline has not been validated against a criterion walkway in older adults walking under graded cognitive load.
